...
_   _ _   _ _____  ______  _____ ____ ___    _    
 | | | | \ | |_ _\ \/ /  _ \| ____|  _ \_ _|  / \   
 | | | |  \| || | \  /| |_) |  _| | | | | |  / _ \  
 | |_| | |\  || | /  \|  __/| |___| |_| | | / ___ \ 
  \___/|_| \_|___/_/\_\_|   |_____|____/___/_/   \_\
"
echo -e "\033[31m"
echo -e "\033[32mWHATSAPP : 081234942540\033[0m"
echo -e "\033[31mWEBSITE : https://t.me/Unixpublice"
echo ""

animate_text "ANDA SUDAH TERVERIFIKASI, SILAHKAN MASUKAN LICENSE YANG DI BAGI DARI TDRHOST"
animate_text "JIKA BELUM PUNYA LICENSE SILAHKAN BELI DI TDRHOST, UNTUK HARGA 30K FREE UPDATE LICENSE"
animate_text " CONTACT TDRHOST: "
echo -e "${RED}WHATSAPP: 081234942540${NC}"
...
# Menampilkan opsi tanpa animasi
  ...
  echo -e "${BLUE}[+]            ©COPYRIGHT BY TDRHOST      [+]${NC}"
  echo -e "${BLUE}[+]                                                [+]${NC}"
  echo -e "${BLUE}[+] ============================================== [+]${NC}"
echo ""
 echo -e "${BLUE}[+] ============================================== [+]${NC}"
